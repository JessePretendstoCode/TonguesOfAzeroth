...
Another 60 or so generated tongues and dialects sit behind those, each with its own phonetic style:

- Beasts and creatures: Wolf, Bear, Bat, Boar, Serpent, Cat, Seal, Bird, Ravenspeech, Stag, Orca, and hunter-pet dialects (Raptor, Chimaera, Crocolisk, Core Hound, Spider, Scorpid, Wasp, Sporebat, Turtle and more)
- Peoples and factions: Eldre'Thalassian (the Skyborne tongue, new in *WoW: Forever*), Common, Dark Iron, Gilnean, Goblin, Ogre (Ogri'zhan), Furbolg, Tuskarr, Vrykul, Pandaren, Sprite (Faerie), Sylvan, Moonkin, Trentish
- Elemental, eldritch and ancient: Kalimag, Titan, Draconic, Nerubian (plus Qiraji and Silithid), Nerglish (Murloc), Nazja (Naga), Ethereal, Undead
- Sub-dialects that share a parent's sound: the Troll variants (Amani, Gurubashi, Drakkari), Sindassi and Shalassian under Thalassian, Eredun under Demonic, Forsaken under Gutterspeak, and others
...
- Source and issues: https://github.com/JessePretendstoCode/TonguesOfAzeroth
